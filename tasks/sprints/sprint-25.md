...
- [x] `npm test` — все тесты проходят (600+)
...
- [x] `npm test` — все тесты проходят (621)
- [x] `tests/bot-platform/oidc-verifier.test.js` покрывает happy paths, error paths, edge cases (31 тест)
