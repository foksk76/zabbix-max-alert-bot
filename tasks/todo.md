...
- [ ] Тест Media type в Zabbix выполнен.
- [ ] Получен понятный результат: успешно доставлено или зафиксирована конкретная ошибка.
- [ ] Результат описан без публикации чувствительных значений.
