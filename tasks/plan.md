...
- [ ] Task 10: Documentation complete / CI pending — варианты повторной отправки и журнала доставки.
...
- [ ] `npm test` подтвержден после изменений Task 10.
...
- Нет открытых задач текущего этапа без ожидания CI по Task 10.
